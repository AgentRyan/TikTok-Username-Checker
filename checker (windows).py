...
try:
    ...
    input("Insufficient modules, please install the requirements before using (Read README.md file for help)")
...
class tiktok:
    ...
    def update_title(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(
            f"Checker Stats | Available: {self.available} | Unavailable: {self.unavailable} | Checked: {(self.available + self.unavailable)} | Remaining: {remaining} | @agentryan on GitHub"
        )
